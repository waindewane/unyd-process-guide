export type EvidenceState = 'verified' | 'working example' | 'needs publication check';
...
export const processes: ProcessGuide[] = [
  {
    ...
    timeline: [
      { when: 'From November', action: 'Annotated agenda and organization of work', detail: 'These documents identify the priority theme, emerging issue, Secretary-General reports, panels, Bureau and day-by-day session structure. Use them to name the exact file when contacting your country’s Permanent Mission in New York.', href: 'https://social.desa.un.org/csocd/65th-session' },
    ...
    examples: [
      ...
      {
        kind: 'Side event',
        title: 'Youth breakfast and political-inclusion workshop at CSocD64',
        detail: 'A documented 2026 lead showing the range from informal networking to a youth-organized workshop. Public artefacts still need clearance before publication.',
        state: 'needs publication check',
      },
    ],
    contacts: [
  ...
  },
  {
    ...
    timeline: [
      { when: 'When the session page opens', action: 'Priority theme, review theme and official documents', detail: 'The priority theme normally drives the negotiated Agreed Conclusions. The review theme examines implementation of an earlier outcome. The documents page then adds the agenda, reports, organization of work and draft outcomes.', href: 'https://www.unwomen.org/en/how-we-work/commission-on-the-status-of-women' },
    ...
    examples: [
      {
        kind: 'Statement',
        title: 'Austrian UN Youth Delegate participation at CSW68',
        detail: 'An official-delegation example including a youth-delegate statement. A stable public recording or transcript still needs to be added.',
        state: 'needs publication check',
      },
      {
        kind: 'Policy / negotiation',
  ...
  },
  {
    ...
    structure: [
      { when: 'Before April', label: 'Preparation', detail: 'Theme selection, event proposals and delegation planning' },
    ...
    negotiations: {
      ...
      leadTime:
        'Monitor the official Forum page from February. A side-event partnership may need to exist before the March call closes; in 2025 the documented proposal was submitted on 5 March, approved on 17 March and shared with the Austrian authorities and Permanent Mission in New York alongside the speaking request on 21 March.',
      route:
  ...
  },
  {
    ...
    examples: [
      {
        kind: 'Policy / negotiation',
        title: 'Youth input around a Voluntary National Review',
        detail: 'The strongest HLPF role may begin in the domestic VNR process rather than in New York. This example slot should be filled with a cleared national case.',
        state: 'needs publication check',
      },
      {
        kind: 'Side event',
        title: 'Cross-country UNYD side-event coordination',
        detail: 'The coordination archive contains recurring HLPF calls and collaboration offers; individual public flyers and recordings still need to be collected.',
        state: 'working example',
      },
      {
        kind: 'Meeting',
        title: 'Informal exchange with advisers to the President of the General Assembly',
        detail: 'A documented HLPF example of using the week for targeted institutional feedback outside the formal plenary.',
        state: 'needs publication check',
      },
    ],
    contacts: [
  ...
  },
  {
    ...
    timeline: [
      ...
      { when: 'Late September–early October', action: 'Open the Third Committee working pages', detail: 'Use the official calendar, meeting pages, documentation and presenter list to locate agenda items, report presentations, speaking formats, proposals and action dates.', href: 'https://www.un.org/en/ga/third/' },
    ...
    examples: [
      ...
      },
      {
        ...
        detail: 'A compilation of national UN Youth Delegate statements delivered in the Third Committee general discussion. These are delegation statements scheduled under a specific agenda item; interventions during interactive dialogues are separate speaking slots with their own registration and timing.',
        state: 'verified',
        href: 'https://www.instagram.com/reel/DBgSKojtEW6/',
      },
      {
        kind: 'Initiative',
    ...
    sources: [
      ...
      { label: 'UNGA80 Third Committee documentation', href: 'https://www.un.org/en/ga/third/80/documentation.shtml' },
  ...
  },
  {
    ...
    location: 'Geneva',
    date2027: '22 February–2 April · 14 June–9 July · 6 September–8 October 2027',
    dateStatus: 'official',
    summary:
    ...
    structure: [
      ...
      { when: '22 Feb–2 Apr', label: '64th regular session', detail: 'Includes the annual full-day meeting on the rights of the child, on children’s mental health and well-being' },
    ...
    negotiations: {
      focus:
        'Each regular session has a programme of work, mandated reports, interactive dialogues, panels and draft resolutions. The three-year programme is the best early-warning tool; the live session page then becomes the operational source for the changing schedule, speaker registration and resolution documents.',
      watch: [
        'The three-year programme of work and the session’s list of reports.',
        'The live session page: programme of work, SCHED or session calendar, speakers lists, A–Z guide, zero drafts, draft resolutions, revisions, programme-budget implications, recordings and webcasts. The programme can change during the session.',
        'The exact speaking format. Interactive dialogues respond to a mandate holder or report, general debates address an agenda item, and panel discussions have their own registration procedure; the Mission must check the current speaker-list rules and limits.',
        'To forecast recurring resolutions, compare the same seasonal session in the previous one to three years, identify the recurring sponsor or core group, and ask when the zero draft and informal consultations are expected.',
        'The resolution sequence: zero draft, informal consultations and paragraph-by-paragraph readings, revisions, bilateral work with the penholder or core group, tabling under an A/HRC/…/L… symbol, amendments or programme-budget implications, and final action.',
        'The current A–Z guide or Secretariat notice for the actual tabling and action deadlines. Observer delegations can engage in informals and sponsor drafts, but only the Council’s 47 members take part in voting and action.',
      ],
      leadTime:
        'Aim to contact your country’s Permanent Mission in Geneva around eight weeks before the relevant session. Name the exact report, panel, dialogue or resolution; ask whether the country sponsored or co-sponsored the previous iteration, because previous co-sponsors may receive pre-zero-draft text or invitations to co-sponsor meetings.',
      route:
        'Begin with the human-rights team at your country’s Permanent Mission in Geneva. In an informal consultation, useful input means clause-specific wording stated in the room and then sent in writing to the penholder or core group through the national delegation.',
    },
    negotiationDownloads: [
      {
        label: 'HRC 2027 recurring-resolution forecast (.xlsx)',
        description: 'Dated 29 August 2026. This is a first research attempt to forecast recurring HRC files, not an official or continuously updated forecast; re-check it against the live session pages.',
        href: 'https://waindewane.github.io/unyd-process-guide/downloads/HRC_2027_Recurring_Resolution_Forecast.xlsx',
        download: true,
      },
    ],
    timeline: [
      ...
      { when: 'Around 8 weeks before', action: 'Contact your country’s Permanent Mission in Geneva', detail: 'Name the exact agenda item, report, panel or resolution. Ask about accreditation, the speaking or submission route, the country’s previous sponsor or co-sponsor role and the national delegation’s internal deadline for text input.' },
      { when: 'When the session page opens', action: 'Use the session page as the operational hub', detail: 'Check the changing programme, SCHED or session calendar, speaker lists, A–Z guide, reports, zero drafts, draft resolutions, revisions, programme-budget implications, recordings and webcasts. Interactive dialogues, general debates and panel discussions use different registration procedures.', href: 'https://hrcportal.ohchr.org/hrc-sessions' },
      { when: 'Before drafting starts', action: 'Check whether the resolution file recurs', detail: 'Compare the same seasonal session in the previous one to three years, identify the recurring sponsor or core group, and ask when the zero draft and informal consultations are expected.', href: 'https://waindewane.github.io/unyd-process-guide/downloads/HRC_2027_Recurring_Resolution_Forecast.xlsx' },
      { when: 'During the session', action: 'Follow the resolution from zero draft to action', detail: 'Track the zero draft, paragraph-by-paragraph informal consultations, revised drafts, bilateral work, the A/HRC/…/L… document, amendments and programme-budget implications. Present clause-specific wording and send it in writing through the national delegation; obtain the live tabling and action deadlines from the current A–Z guide or Secretariat notice.', href: 'https://hrcportal.ohchr.org/practical-information' },
      { when: 'At action', action: 'Check the national delegation’s formal role', detail: 'All delegations can engage in public informals, and observer States may sponsor and introduce drafts, but only the Council’s 47 members participate in voting and formal action.' },
      { when: 'After adoption', action: 'Trace the next mandated opening', detail: 'Read the adopted operative paragraphs for the next report, panel, study, consultation, call for input or return session, and add that concrete follow-up to the process watch.' },
    ],
    examples: [
      {
        kind: 'Initiative',
        title: 'Open letter on a Special Procedure for the rights of younger persons',
        detail: 'Italian UN Youth Delegates coordinated a cross-country letter to HRC members and linked it to upcoming sessions and Mission outreach.',
        state: 'working example',
      },
      {
        kind: 'Statement',
    ...
    sources: [
      ...
      { label: 'Peacocks & Procedure · public 2024 edition (independent guide)', href: 'https://blogs.fcdo.gov.uk/wp-content/uploads/Peacocks-Procedure2024.pdf' },
    ],
  },
  {
    id: 'cnd',
